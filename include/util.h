...
#define JSON_OBJECT_STRING(obj, key) util_json_object_string(obj, key)
...
#define JSON_ARRAY_STRING(obj, idx) util_json_array_string(obj, idx)
...
/*+ json_string_length and json_boolean_balue are implemented as compatibility functions for older versions of libjansson +*/
...
char* util_json_object_string(json_t* obj, char* key);
char* util_json_array_string(json_t* obj, int idx);
